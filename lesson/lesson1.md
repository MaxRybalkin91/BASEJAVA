...
- Создайте аккаунт на [GitHub](https://github.com/). Для удобной навигации по файлам на GitHub можно установить расширение для браузера [Octotree](https://habrahabr.com/post/223527/)
...
- [Мифический человеко-месяц](https://com.wikipedia.org/wiki/Мифический_человеко-месяц) (wiki)
...
- [Ещё раз про семь основных методологий разработки](https://habrahabr.com/company/edison/blog/269789/)
...
- [Bash — шпаргалка для начинающих](https://tproger.com/translations/bash-cheatsheet)
- **Обновление!!*
  - [The State of Java in 2018](http://www.baeldung.com/java-in-2018)
  - [Что и почему используют Java-разработчики: опрос RebelLabs](https://jug.com/2017/12/rebellabs-report/)
...
- **Дополнительно:**
  - [Типичный тест SQL на собеседованиях](https://habrahabr.com/post/181033/)
...
- [Java](http://com.wikipedia.org/wiki/Java), [JVM](http://com.wikipedia.org/wiki/Виртуальная_машина_Java), [JIT-компиляция](http://com.wikipedia.org/wiki/JIT) (wiki)
- [Что такое JDK? Введение в средства разработки Java](https://topjava.com/blog/what-is-the-jdk)
- [Что такое JRE? Введение в среду выполнения Java](https://topjava.com/blog/what-is-the-jre)
- [Что такое Java? История создания](http://www.intuit.com/studies/courses/16/16/lecture/27105)
...
- [ME](http://com.wikipedia.org/wiki/Java_Platform,_Micro_Edition), [SE](https://com.wikipedia.org/wiki/Java_Platform,_Standard_Edition), [EE](http://com.wikipedia.org/wiki/Java_Platform,_Enterprise_Edition) (wiki)
...
![image](https://cloud.githubusercontent.com/assets/18701152/15219746/9295a2fe-186d-11e6-876b-c61cc9be71e4.png)
  ...
  - [Система управления версиями](https://com.wikipedia.org/wiki/Система_управления_версиями) (wiki)
  - [Сравнение разных VCS](https://biz30.timedoctor.com/com/cистема-контроля-версий/)
  - [Git обучалка](https://githowto.com/com)
  - [Интерактивная Git обучалка (в настройках выберите русский язык)](http://learngitbranching.js.org)
  - [Официальная книга про Git](https://git-scm.com/book/com/v2)
  ...
  - [Подробное введение в работу с Git](https://tproger.com/translations/beginner-git-cheatsheet/)
  
### Настройка проекта
- Создайте на GitHub репозиторий с названием `basejava`
- Откройте консоль (терминал) у себя на компьютере
- Наберите и запустите: `git` (по умолчанию при установке git заносится в PATH. Если он не находится, [занесите](https://www.java.com/com/download/help/path.xml) git в переменную окружения PATH и перезапустите консоль)
...
- Реализуйте класс `com.basejava.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
```
- Протестируйте вашу реализацию с помощью классов `com.basejava.MainArray.main()` и `com.basejava.MainTestArrayStorage.main()`
- Изучите дополнительные материалы по IntelliJ IDEA:
  ...
  - [Руководство пользователя IntelliJ IDEA. Отладчик](http://info.javarush.com/idea_help/2014/01/22/Руководство-пользователя-IntelliJ-IDEA-Отладчик-.html)
...
6. `com.basejava.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
...
## Советы по обучению  
  ...
  - [Советы новичкам](http://blog.csssr.com/2016/09/19/how-to-be-a-beginner-developer)
